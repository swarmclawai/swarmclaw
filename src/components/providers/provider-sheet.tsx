        ...
        {isBuiltin ? (
          <>
            ...
            {editingId === 'ollama' && localLoading && (
              <p className="text-[11px] text-text-3/40 mb-3">Checking local Ollama instance...</p>
            )}
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-3 rounded-[14px] border-none bg-primary/10 text-primary text-[13px] font-600
                  cursor-pointer disabled:opacity-30 hover:bg-primary/20 transition-all shrink-0"
                style={{ fontFamily: 'inherit' }}
              >
                Add
              </button>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            <div
              ...
              className={`w-11 h-6 rounded-full transition-all duration-200 relative cursor-pointer
                ${requiresApiKey ? 'bg-primary' : 'bg-white/[0.08]'}`}
            >
              <div className={`absolute top-0.5 w-5 h-5 rounded-full bg-primary-foreground transition-all duration-200
      ...
      {showApiKey && (
        <div className="mb-8">
          ...
          {credList.length > 0 && !addingKey ? (
            ...
            <div className="space-y-3 p-4 rounded-[12px] border border-primary/15 bg-primary/5">
              <input
                type="text"
                value={newKeyName}
        ...
        <div className="mb-8">
          <label className="flex items-center gap-3 cursor-pointer">
            <div
              ...
              className={`w-11 h-6 rounded-full transition-all duration-200 relative cursor-pointer
                ${isEnabled ? 'bg-primary' : 'bg-white/[0.08]'}`}
            >
              <div className={`absolute top-0.5 w-5 h-5 rounded-full bg-primary-foreground transition-all duration-200
